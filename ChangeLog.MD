...
## 1/8/2019
### Added
- Race Server (Will be referred to as RS in future changes)
- Glowing Rotors on braking
- Traction Control (Toggled with Z)
- Death Cam (Now move camera around when dead)

### Changed
- Loading Screen (RS)
- Liveries on Hotring (RS)
- Updated FRFuel (RS)
- Fixed Whitelist (RS)
- Fixed SO1 lights
- Fixed Torque
